#!/usr/bin/env sh
# install.sh — install the n (Node.js version manager) binary
set -e
...
printf "  ${CYAN}export PATH=\"\$HOME/.local/bin:\$PATH\"${NC}   # for the n binary\n"
printf "  ${CYAN}export PATH=\"\$HOME/.n/bin:\$PATH\"${NC}        # for managed Node.js binaries\n"
